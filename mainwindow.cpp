...
void MainWindow::getDataFromPacket()
{
    ...
    QString Temp_read_1 = QString::number(payload_int16[2],10);
    QString Temp_read_2 = QString::number(payload_int16[3],10);
    ui->lineEditPrdRead->setText(dab_prd_read);
    ui->lineEditPhsRead->setText(dab_phs_read);
    ui->lcd_Temp->display(Temp_read_1);
    ui->lcd_Temp1->display(Temp_read_2);
